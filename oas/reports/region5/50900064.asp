...
<h1><a name="begin_content"></a>Audit (A-05-09-00064)</h1>

<h2>09-21-2009<br />
National Institutes of Health–Internal Control Review of the Process for Awarding American Recovery and Reinvestment Act Funds</h2>

<h2 class="line">Executive Summary</h2>

<p>Our review found that the National Institutes of Health’s (NIH) internal controls for awarding American Recovery and Reinvestment Act of 2009 (Recovery Act) funds to grantees, as described by management, were suitably designed to provide reasonable assurance that the specified internal control objectives would be achieved if the described internal controls were complied with satisfactorily and applied as designed.  However, we did not perform procedures to determine the operating effectiveness of these internal controls.  Accordingly, we express no opinion on the operating effectiveness of any aspects of NIH’s internal controls for awarding Recovery Act funds, individually or in the aggregate.</p>
...
<a href="/oas/reports/region5/50900064.pdf" target="_blank">complete report</a>
