...
<meta name="keywords" content="Independent Attestation Review:   Indian Health Services Fiscal Year 2012 Performance Summary Report for National Drug Control Activities and Accompanying Required Assertions (A-03-13-00356) 01-18-2013" />
<meta name="description" content="Independent Attestation Review:   Indian Health Services Fiscal Year 2012 Performance Summary Report for National Drug Control Activities and Accompanying Required Assertions (A-03-13-00356) 01-18-2013" />
<title>Independent Attestation Review:   Indian Health Services Fiscal Year 2012 Performance Summary Report for National Drug Control Activities and Accompanying Required Assertions (A-03-13-00356) 01-18-2013</title>
...
<a data-text="Ind. Attestation Rvw: IHS FY2012 Nat Drug Control Activity & Req Assertions Perf Summary Rpt" 
...
<h1>Audit (A-03-13-00356)</h1>

<h2>01-18-2013<br />
Independent Attestation Review:   Indian Health Services Fiscal Year 2012 Performance Summary Report for National Drug Control Activities and Accompanying Required Assertions</h2>

<h2 class="line">Complete Report</h2>

<p class="download">Download the 

<a href="/oas/reports/region3/31300356.pdf" target="_blank">complete report</a>
...
<p>We performed an attestation review of the Indian Health Service (IHS) Performance Summary Report for National Drug Control Activities and accompanying required assertions for fiscal year (FY) 2012.  </p>

<p>As authorized by Federal statute (21 U.S.C. &#167; 1703(d)(7)), and in compliance with the Office of National Drug Control Policy (ONDCP) Circular, Drug Control Accounting, dated May 1, 2007, ONDC P requested that we perform this review.  Each National Drug Control Program agency must submit to the Director of ONDCP an annual evaluation of the progress by the agency with respect to drug control program goals using the performance measures established for that agency (21 U.S.C. &#167; 1703(b)(13)).  The Circular provides the requirements for the report, including requirements for the agencies' assertions to its accuracy.</p>
  
<p>Based on our review, nothing came to our attention that caused us to believe that IHS's Performance Summary Report for National Drug Control Activities and accompanying required assertions for FY 2012 were not fairly stated, in all material respects, based on the Circular.</p>
