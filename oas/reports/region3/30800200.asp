...
<h1><a name="begin_content"></a>Audit (A-03-08-00200)</h1>

<h2>10-06-2008<br />
Follow-up Audit of the Medicaid Drug Rebate Program in West Virginia
</h2>

<h2 class="line">Executive Summary</h2>

<p>We found that the State had implemented all but one of the recommendations from our previous audit.  We recommended that the State resolve Medicaid drug rebate disputes in a timely manner.  The State concurred with the recommendation. </p>

<h2 class="line">Complete Report</h2>

<p  class="download"> Download the 

<a href="/oas/reports/region3/30800200.pdf" target="_blank">complete report</a>
