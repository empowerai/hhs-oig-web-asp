...
<h1><a name="begin_content"></a>Audit (A-04-09-01065)</h1>

<h2>03-09-2010<br />
National Institute of Environmental Health Sciences:  Internal Control Review of the Process for Awarding American Recovery and Reinvestment Act Funds </h2>

<h2 class="line">Executive Summary</h2>


<p>The internal controls for awarding Recovery Act funds to grantees, as described by management, are suitably designed to provide reasonable assurance that the specified internal control objectives would be achieved if the described internal controls were complied with satisfactorily and applied as designed.  However, we did not perform procedures to determine the operating effectiveness of these internal controls.  Accordingly, we express no opinion on the operating effectiveness of any aspects of NIEHS’s controls for awarding Recovery Act funds, individually or in the aggregate.</p>
...
<a href="/oas/reports/region4/40901065.pdf" target="_blank">complete report</a>
