...
<h1><a name="begin_content"></a>Audit (A-04-07-07023) </h1>
...
<p>In a follow-up audit of Mississippi's Medicaid drug rebate program, we found that, as of June 30, 2006, the State corrected the previous weakness by upgrading its computer system to verify the accuracy of the accrual and collection of interest.  However, it had not established controls over collecting rebates on single source drugs administered by physicians.</p>

<p>In August 2007, the State agency began billing pharmaceutical manufacturers for single source drugs administered by physicals and claimed to have collected over $21 million in rebates as of September 2008. </p>

<h2 class="line">Complete Report</h2>

<p  class="download"> Download the 

<a href="/oas/reports/region4/40707023.pdf" target="_blank">complete report</a>
