...
<h1><a name="begin_content"></a>Audit (A-01-08-01500)</h1>

<h2>06-25-2009<br />
Review of Vermont's Pandemic Influenza Expenditures for the Period August 31, 2005, Through June 30, 2008</h2>

<h2 class="line">Executive Summary</h2>


<p>As of June 30, 2008, the State had not spent $1.32 million, or 44 percent, of the $2.36 million in pandemic influenza (pan flu) funding that it received from the Centers for Disease Control and Prevention (CDC).  The State attributed the unspent funds to delays in receiving supplemental guidance and funding from CDC for award phases I and II and to Vermont's legislative and administrative procedures, which caused delays in bringing new positions online.  Of the $1.32 million that the State charged to the award, $5,439 was not allowable.  Specifically, $4,753 should have been charged to another CDC award, and $686 was not supported by the required documentation.</p>

<p>We recommended that the State amend the final pan flu financial status reports to reverse the $4,753 incorrectly charged to the pan flu award and to refund the $686 that lacked required documentation.  The State agreed with our findings and recommendation.</p>
...
<a href="/oas/reports/region1/10801500.pdf" target="_blank">complete report</a>
