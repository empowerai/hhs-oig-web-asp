...
<h1><a name="begin_content"></a>Audit (A-01-09-00509)</h1>

<h2>08-25-2009<br />
Review of Emergency Department Procedure Codes Billed by Cape Cod Emergency Associates</h2>

<h2 class="line">Executive Summary</h2>


<p>Claims billed by Cape Cod Emergency Associates (CCEA) for emergency department services did not always meet certain Medicare requirements.  Specifically, 42 of the 100 claims that we reviewed were for services that were either incorrectly coded (39 claims) or incorrectly billed (3 claims).  The incorrectly coded claims resulted in overpayments and underpayments to CCEA that, when netted, were immaterial, and the incorrectly billed claims resulted in $235 in overpayments to CCEA. </p> 

<h2 class="line">Complete Report</h2>

<p  class="download"> Download the 

<a href="/oas/reports/region1/10900509.pdf" target="_blank">complete report</a>
