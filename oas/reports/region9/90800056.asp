...
<h1><a name="begin_content"></a>Audit (A-09-08-00056) </h1>

<h2>05-07-2009<br />
Review of California's Compliance With Demonstration Project Requirements for Reimbursement of State Costs for Provision of Medicare Part D Drugs (Claims Processed Through the Medicaid Management Information System)</h2>

<h2 class="line">Executive Summary</h2>

<p>For the $55.8 million in drug claims processed through the Medicaid Management Information System, the California Department of Health Care Services (the State agency) complied with certain provisions of the Medicare "Section 402 Demonstration Application" when claiming drug costs for full-benefit dually eligible beneficiaries.  However, the State agency claimed drug costs to both the Medicaid program and the Medicare demonstration project.  Subsequently, the State agency adjusted the Forms CMS-64 to remove demonstration project costs.</p>
...
<a href="/oas/reports/region9/90800056.pdf" target="_blank">complete report</a>
