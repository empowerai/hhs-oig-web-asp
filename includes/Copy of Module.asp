...
<br />
<br />
<input type="radio" id="rdoIdentify" name="rdoIdentify" value="No" <%if Request.Form("rdoIdentify") = "No" then %>
...
<div>
    <table cellpadding="0" cellspacing="0" border="0" width="100%">
		...
		<tr>
            ...
            <label for="recaptcha_response_field">Please enter the text from the image, then click 'Next':</label>
            ...
            <a style="cursor:pointer;" onclick="javascript:Recaptcha.switch_type('image')" id="lnkImage">Get another CAPTCHA</a> 
            &nbsp;|&nbsp;<a style="cursor:pointer;" onclick="javascript:switchMode(this)" id="lnkAudio">Get Audio CAPTCHA</a>  &nbsp;|&nbsp;<a style="cursor:pointer;" onclick="javascript:Recaptcha.showhelp()" id="A1">What is CAPTCHA?</a>  
            </td>
        </tr>
    </table>
</div>
...
<br />
<br />
<input type="submit" value="  Next  " id="Submit1" name="objSubmit" style="margin-left: 15px">
<%
End Sub
...
<table width="500" style="margin-left: 10px;">
    <tr>
        <td align="left" valign="top">
            <nobr><label for="fname">First name:</label> <img src="http://oig.hhs.gov/images/required.gif" alt="* required">
</nobr>
        </td>
        <td>
    ...
    <tr>
        <td align="left" valign="top">
            <label for="lname">
                Last name:</label>
            <img src="http://oig.hhs.gov/images/required.gif" alt="* required">
        </td>
        <td>
    ...
    <tr>
        <td align="left" valign="top">
            <nobr><label for="state">State</label> <img src="http://oig.hhs.gov/images/required.gif" alt="* required">
        </td>
        <td>
            <nobr>
...
<br />
<br />
<input type="submit" value="  Next  " id="objSubmit" name="objSubmit">
<%
End Sub
    ...
    <tr>
        <td align="left" valign="top">
            <label for="strSubjectName">
                Name:</label><img src="http://oig.hhs.gov/images/required.gif" alt="* required">
        </td>
        <td>
            <input  type="text" name="strSubjectName" id="strSubjectName"
                size="40" maxlength="125" value="<%= unticks(strSubjectName) %>">
        </td>
    </tr>
    <tr>
        <td align="left" valign="top">
...
<%= strSubjectOptions%>
    ...
    <tr>
        <td colspan="2">
            <input type="button" id="btnAddSubject_1" name="btnAddSubject_1" value="Add Another Subject"
...
<%= strSubjectOptions%>
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <input type="button" id="btnAddSubject_<%=intSubjectPanelCount%>" name="btnAddSubject_<%=intSubjectPanelCount%>"
                            value="Add Another Subject" onclick="javascript:LaunchSubjectPanel(<%=intSubjectPanelCount + 1%>)">
                        <% end if %>
                        <input type="button" id="btnRemoveSubject_<%=intSubjectPanelCount%>" name="btnRemoveSubject_<%=intSubjectPanelCount%>"
    ...
    <tr>
        <td colspan="2">
            ...
            <ul type="disc">
                ...
                amount charged, amount approved/paid) in the Complaint Narrative.
            </ul>
            Complaint Narrative
            <br />
...
<input type="submit" value="  Submit this complaint  " id="objSubmit" name="objSubmit"></p>
<%
End Sub 
    ...
    <tr>
        <td valign="top" colspan="2" style="padding-top: 20px">
            <td>
                ...
                Act officer (<a href="http://oig.hhs.gov/foia/submit.asp">http://oig.hhs.gov/foia/submit.asp</a>).
...
Sub RegurgitateFormFields()
	...
	for i = 1 to Request.Form.Count
		...
		If strFormField <> "currentPage" and strFormField <> "objSubmit" then
			...
			Response.Write("<input type=""hidden"" id=""hid_" & strFormFieldIdAndName & """ name=""hid_" & strFormFieldIdAndName & """ value=""" & Request.Form(strFormField) & """>" & vbcr)
		end if
...
Sub RegurgitateFormFieldsUsingMultiType()
	...
	For i = 0 to objUploader.FormItemCount - 1
		...
		If strFormFieldIdAndName <> "currentPage" and strFormFieldIdAndName <> "objSubmit"  then
			if strFormFieldIdAndName = "selcomplainttype" then
				strFormField = DecodeSelectedValue(strFormField, "ComplaintTypes", objConn)
			Elseif strFormFieldIdAndName = "selhhsdept" then
				strFormField = DecodeSelectedValue(strFormField, "HHSDeptTypes", objConn)
			Elseif strFormFieldIdAndName = "hid_rdoidentify" then
