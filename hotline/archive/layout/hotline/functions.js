	var cache = {}; // caching inputs for the visited steps
			...
			//		outDuration: 700,
				 	//formOptions :{
					//	success: function(data){$("#status").fadeTo(500,1,function(){ $(this).html("You are now registered!").fadeTo(4000, 0); })},
...
//// js for allegation against

		
					$('#allegation').change(function() {
					if ($(this).val() == 'person') { 
						  $('#personAllegation').fadeIn();
						  $('#businessAllegation').fadeOut();
						
					}
					if ($(this).val() == 'business') { 
						 $('#businessAllegation').fadeIn();
						  $('#personAllegation').fadeOut();
					}
				});		
				...
				// limits the main textarea to 3000
					$('.hcfc_describe_fraud').limit('3000','.charsLeftThree');
...
/////////////////////////////////////////////////////////////
				...
				$('.qocc_when_occurred').limit('250','.charsLeftSix');
				
				//limit qocc_when_occurred to 250
				$('.qocc_incident_length').limit('250','.charsLeftSeven');	
				
				//limit qocc_describe_abuse to 3000
				$('.qocc_describe_abuse').limit('3000','.charsLeftEight');
...
/////////////////////////////////////////////////////////////
				...
				$('.gcfc_describe_fraud').limit('3000','.charsLeftThirteenOne');					
				
				//limit gcfc_grant_number to 200
				$('.gcfc_grant_number').limit('200','.charsLeftNine');					
	...
	/////////////////////////////////////////////////////////////
				...
				$('.cac_when_occurred').limit('250','.charsLeftSeventeen');			
				
				//limit cac_incident_length to 250
				$('.cac_incident_length').limit('250','.charsLeftEigthteen');		
				
				//limit cac_describe_abuse to 3000
				$('.cac_describe_abuse').limit('3000','.charsLeftNineteen');					
			...
			/////////////////////////////////////////////////////////////
				...
				$('.mitc_when_occurred').limit('250','.charsLeftTwentyOne');			
				
				//limit mitc_incident_length to 250
				$('.mitc_incident_length').limit('250','.charsLeftTwentyTwo');		
				
				//limit mitc_describe_medical_id_theft to 3000
				$('.mitc_describe_medical_id_theft').limit('3000','.charsLeftTwentyThree');					
			...
			//file upload js
				...
				$('.oc_describe_activity').limit('3000','.charsLeftTwentySix');		
